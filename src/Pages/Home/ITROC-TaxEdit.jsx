...
const Itroc= () => {
  ...
  className="slide-1"
  style={{
    backgroundImage: `url('/img/roc.jpg')`
  }}
></div>
          <div className="hero">
            <hgroup>
              <h3 style={{color:"white",}}>LLP Annual Compliance | IT ROC & Tax Audit </h3>
            </hgroup>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="portfolio_section">
          ...
          <ol>
            ...
            <li>LLP Incorporation Certificate</li><br/>
            <li>LLP Agreement Document soft copy</li><br/>
